			...
			<div class="large-6 large-offset-3 small-12 columns">
				...
				<div class="row collapse">
					<div class="small-9 small-offset-3">
						{{ Form::checkbox('artist', null, Input::has('artist'), array('id' => 'artist')) }}<label for="artist">Artist</label>
						{{ Form::checkbox('album', null, Input::has('album'), array('id' => 'album')) }}<label for="album">Album</label>
						{{ Form::checkbox('song', null, Input::has('song'), array('id' => 'song')) }}<label for="song">Song</label>
					</div>
				</div>
